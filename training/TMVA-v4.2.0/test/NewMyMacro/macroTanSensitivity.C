...
//TMVA_main_v25_Np1_nomoremuaxis2jet2q.rootTMVA_main_v25_Np1_nomoresolonomoremuaxis2jet2q.root

//int main(){
void macroTanSensitivity(){

        TFile *file = new TFile("/afs/cern.ch/user/a/abonavit/private/tesi/training/CMSSW_8_0_28/src/training/TMVA-v4.2.0/test/output/TMVA_main_v25_Np1_nomorenominalmuaxis2jet2q.root");
